...
enum PrayerVisualTheme: String, CaseIterable, Identifiable {
    ...
    static let nightChoices: [PrayerVisualTheme] = [.nightCrystalGlass, .nightSalatiGlass, .nightAppleGlass, .nightSakinaGlass]
    static let dayChoices: [PrayerVisualTheme] = [.dayCrystalGlass, .daySalatiGlass, .dayAppleGlass, .dayOasisGlass]
    ...
    var modeTitle: String {
        isNightTheme ? "نمط الليل" : "نمط النهار"
    }
    ...
    var isNightTheme: Bool {
        switch self {
        case .nightOld, .nightEmerald, .nightMidnight, .nightAmber, .nightViolet, .nightCalendar, .nightGlass, .nightDawnGlass, .nightSakinaGlass, .nightAppleGlass, .nightSalatiGlass, .nightCrystalGlass:
            return true
        case .dayMint, .dayPearl, .daySky, .dayOlive, .dayAqua, .dayGlass, .dayDawnGlass, .dayOasisGlass, .dayAppleGlass, .daySalatiGlass, .dayCrystalGlass, .dayRose:
            return false
        }
    }

    var isGlassTheme: Bool {
        self == .nightGlass || self == .dayGlass || self == .nightDawnGlass || self == .dayDawnGlass || self == .nightSakinaGlass || self == .dayOasisGlass || self == .nightAppleGlass || self == .dayAppleGlass || self == .nightSalatiGlass || self == .daySalatiGlass || usesNativeMaterialGlass
    }

    var usesNativeMaterialGlass: Bool {
        self == .nightCrystalGlass || self == .dayCrystalGlass
    }
    ...
    var palette: ThemePalette {
        ...
        case .nightDawnGlass:
            return ThemePalette(
                appBackground: [
                    Color(red: 0.000, green: 0.015, blue: 0.026),
                    Color(red: 0.020, green: 0.080, blue: 0.115),
                    Color(red: 0.000, green: 0.145, blue: 0.135),
                    Color(red: 0.155, green: 0.105, blue: 0.030)
                ],
                widgetBackground: [Color(red: 0.018, green: 0.090, blue: 0.125), Color(red: 0.000, green: 0.020, blue: 0.035)],
                accent: Color(red: 1.00, green: 0.76, blue: 0.30),
                primaryText: .white,
                secondaryText: Color(red: 0.76, green: 0.94, blue: 0.91),
                mutedText: .white.opacity(0.82),
                panelBackground: Color(red: 0.10, green: 0.15, blue: 0.16).opacity(0.94),
                countdownBackground: Color(red: 0.58, green: 0.39, blue: 0.10).opacity(0.98),
                rowBackground: Color(red: 0.12, green: 0.17, blue: 0.18).opacity(0.82),
                activeRowBackground: Color(red: 0.50, green: 0.36, blue: 0.12).opacity(0.74),
                rowBorder: .white.opacity(0.20),
                activeRowBorder: Color(red: 1.00, green: 0.76, blue: 0.30).opacity(0.70),
                chipBackground: Color(red: 0.16, green: 0.23, blue: 0.24).opacity(0.84),
                controlBackground: Color(red: 0.15, green: 0.22, blue: 0.23).opacity(0.90),
                controlPressedBackground: Color(red: 0.26, green: 0.24, blue: 0.17).opacity(0.90),
                controlBorder: .white.opacity(0.26)
            )
        case .nightSakinaGlass:
            return ThemePalette(
                appBackground: [
                    Color(red: 0.005, green: 0.020, blue: 0.022),
                    Color(red: 0.018, green: 0.095, blue: 0.088),
                    Color(red: 0.012, green: 0.035, blue: 0.052),
                    Color(red: 0.115, green: 0.078, blue: 0.020)
                ],
                widgetBackground: [Color(red: 0.020, green: 0.090, blue: 0.088), Color(red: 0.006, green: 0.020, blue: 0.026)],
                accent: Color(red: 1.00, green: 0.78, blue: 0.36),
                primaryText: .white,
                secondaryText: Color(red: 0.76, green: 0.94, blue: 0.89),
                mutedText: .white.opacity(0.84),
                panelBackground: Color.white.opacity(0.118),
                countdownBackground: Color(red: 0.50, green: 0.34, blue: 0.10).opacity(0.96),
                rowBackground: Color.white.opacity(0.078),
                activeRowBackground: Color(red: 0.80, green: 0.58, blue: 0.20).opacity(0.22),
                rowBorder: .white.opacity(0.16),
                activeRowBorder: Color(red: 1.00, green: 0.78, blue: 0.36).opacity(0.62),
                chipBackground: .white.opacity(0.14),
                controlBackground: .white.opacity(0.13),
                controlPressedBackground: .white.opacity(0.08),
                controlBorder: .white.opacity(0.23)
            )
        case .nightAppleGlass:
            return ThemePalette(
                appBackground: [
        ...
        case .nightCrystalGlass:
            return ThemePalette(
                appBackground: [
                    Color(red: 0.002, green: 0.010, blue: 0.020),
                    Color(red: 0.012, green: 0.045, blue: 0.082),
                    Color(red: 0.012, green: 0.105, blue: 0.145),
                    Color(red: 0.004, green: 0.018, blue: 0.034)
                ],
                widgetBackground: [
                    Color(red: 0.008, green: 0.030, blue: 0.055),
                    Color(red: 0.018, green: 0.085, blue: 0.125)
                ],
                accent: Color(red: 0.100, green: 0.610, blue: 1.000),
                primaryText: .white,
                secondaryText: Color(red: 0.825, green: 0.905, blue: 0.970),
                mutedText: .white.opacity(0.82),
                panelBackground: Color.white.opacity(0.105),
                countdownBackground: Color(red: 0.020, green: 0.330, blue: 0.680).opacity(0.78),
                rowBackground: Color.white.opacity(0.068),
                activeRowBackground: Color(red: 0.080, green: 0.570, blue: 1.000).opacity(0.205),
                rowBorder: .white.opacity(0.145),
                activeRowBorder: Color(red: 0.380, green: 0.790, blue: 1.000).opacity(0.68),
                chipBackground: .white.opacity(0.115),
                controlBackground: .white.opacity(0.125),
                controlPressedBackground: .white.opacity(0.075),
                controlBorder: .white.opacity(0.225)
            )
        case .dayMint:
            return ThemePalette(
        ...
        case .dayDawnGlass:
            return ThemePalette(
                appBackground: [
                    Color(red: 0.900, green: 0.982, blue: 1.000),
                    Color(red: 1.000, green: 0.990, blue: 0.900),
                    Color(red: 0.800, green: 0.960, blue: 0.910),
                    Color(red: 0.690, green: 0.880, blue: 0.930)
                ],
                widgetBackground: [Color(red: 0.860, green: 0.970, blue: 1.000), Color(red: 0.880, green: 0.960, blue: 0.880)],
                accent: Color(red: 0.025, green: 0.325, blue: 0.470),
                primaryText: Color(red: 0.000, green: 0.065, blue: 0.095),
                secondaryText: Color(red: 0.110, green: 0.360, blue: 0.410),
                mutedText: Color(red: 0.105, green: 0.260, blue: 0.300).opacity(0.88),
                panelBackground: Color.white.opacity(0.80),
                countdownBackground: Color(red: 0.035, green: 0.315, blue: 0.455).opacity(0.96),
                rowBackground: Color.white.opacity(0.72),
                activeRowBackground: Color(red: 0.080, green: 0.420, blue: 0.560).opacity(0.22),
                rowBorder: .white.opacity(0.92),
                activeRowBorder: Color(red: 0.025, green: 0.325, blue: 0.470).opacity(0.56),
                chipBackground: .white.opacity(0.78),
                controlBackground: .white.opacity(0.82),
                controlPressedBackground: .white.opacity(0.60),
                controlBorder: .white.opacity(0.92)
            )
        case .dayOasisGlass:
            return ThemePalette(
                appBackground: [
                    Color(red: 0.900, green: 0.985, blue: 0.980),
                    Color(red: 0.990, green: 0.980, blue: 0.900),
                    Color(red: 0.780, green: 0.925, blue: 0.885),
                    Color(red: 0.740, green: 0.900, blue: 0.955)
                ],
                widgetBackground: [Color(red: 0.870, green: 0.975, blue: 0.960), Color(red: 0.900, green: 0.955, blue: 0.875)],
                accent: Color(red: 0.020, green: 0.345, blue: 0.405),
                primaryText: Color(red: 0.000, green: 0.075, blue: 0.088),
                secondaryText: Color(red: 0.105, green: 0.355, blue: 0.375),
                mutedText: Color(red: 0.090, green: 0.250, blue: 0.285).opacity(0.88),
                panelBackground: Color.white.opacity(0.70),
                countdownBackground: Color(red: 0.025, green: 0.315, blue: 0.390).opacity(0.95),
                rowBackground: Color.white.opacity(0.58),
                activeRowBackground: Color(red: 0.050, green: 0.410, blue: 0.475).opacity(0.18),
                rowBorder: .white.opacity(0.82),
                activeRowBorder: Color(red: 0.020, green: 0.345, blue: 0.405).opacity(0.50),
                chipBackground: .white.opacity(0.68),
                controlBackground: .white.opacity(0.72),
                controlPressedBackground: .white.opacity(0.54),
                controlBorder: .white.opacity(0.84)
            )
        case .dayAppleGlass:
            return ThemePalette(
                appBackground: [
                    Color(red: 0.986, green: 0.988, blue: 0.992),
                    Color(red: 0.930, green: 0.958, blue: 1.000),
                    Color(red: 0.972, green: 0.980, blue: 0.992),
                    Color(red: 1.000, green: 1.000, blue: 1.000)
                ],
                widgetBackground: [
                    Color(red: 0.970, green: 0.984, blue: 1.000),
                    Color(red: 0.930, green: 0.956, blue: 0.990)
                ],
                accent: Color(red: 0.000, green: 0.478, blue: 1.000),
                primaryText: Color(red: 0.020, green: 0.024, blue: 0.030),
                secondaryText: Color(red: 0.260, green: 0.320, blue: 0.390),
                mutedText: Color(red: 0.300, green: 0.350, blue: 0.420).opacity(0.88),
                panelBackground: Color.white.opacity(0.76),
                countdownBackground: Color(red: 0.000, green: 0.478, blue: 1.000).opacity(0.92),
                rowBackground: Color.white.opacity(0.62),
                activeRowBackground: Color(red: 0.000, green: 0.478, blue: 1.000).opacity(0.122),
                rowBorder: .white.opacity(0.88),
                activeRowBorder: Color(red: 0.000, green: 0.478, blue: 1.000).opacity(0.46),
        ...
        case .dayCrystalGlass:
            return ThemePalette(
                appBackground: [
                    Color(red: 0.955, green: 0.985, blue: 1.000),
                    Color(red: 0.995, green: 0.998, blue: 1.000),
                    Color(red: 0.855, green: 0.945, blue: 1.000),
                    Color(red: 0.925, green: 0.990, blue: 0.965)
                ],
                widgetBackground: [
                    Color(red: 0.935, green: 0.980, blue: 1.000),
                    Color(red: 0.875, green: 0.945, blue: 0.995)
                ],
                accent: Color(red: 0.000, green: 0.500, blue: 1.000),
                primaryText: Color(red: 0.012, green: 0.030, blue: 0.052),
                secondaryText: Color(red: 0.230, green: 0.325, blue: 0.420),
                mutedText: Color(red: 0.275, green: 0.360, blue: 0.445).opacity(0.88),
                panelBackground: Color.white.opacity(0.235),
                countdownBackground: Color(red: 0.000, green: 0.500, blue: 1.000).opacity(0.84),
                rowBackground: Color.white.opacity(0.175),
                activeRowBackground: Color(red: 0.000, green: 0.500, blue: 1.000).opacity(0.125),
                rowBorder: .white.opacity(0.72),
                activeRowBorder: Color(red: 0.000, green: 0.500, blue: 1.000).opacity(0.52),
                chipBackground: .white.opacity(0.285),
                controlBackground: .white.opacity(0.300),
                controlPressedBackground: .white.opacity(0.190),
                controlBorder: .white.opacity(0.78)
            )
        case .dayRose:
            return ThemePalette(
